		        ...
		        <div class="control-group">
		            <div class="event-compose-headers">
		                <div class="controls control-to">
		                	...
		                	<?php if ($Event->getId()) : ?>
		                	<a title="Delete this event" id="btn-delelete-event" href="?app=calendar&view=deleteEvent&id=<?php echo intval($Event->getId()); ?>" class="btn"><i class="awe-remove"></i> Delete</a>
		                	<?php endif; ?>
		                </div>
		                <div class="controls control-start">
		                    <label for="start" class="control-label">Start</label>
		                	<span class="input-append">
								<input name="startDate" class="datepicker input-small" value="" type="text">
								<span class="add-on">
									<i class="awe-calendar"></i>
								</span>
							</span>
							<label for="stateTime" class="timepicker-label">at</label>
							<input name="startTime" class="timepicker input-small" value="" type="text">
							<span class="timepicker-example" data-for="startTime">eg: 8:15am</span>
		                </div>
		                <div class="controls control-end">
		                    <label for="end" class="control-label">End</label>
		                    <span class="input-append">
								<input name="endDate" class="datepicker input-small" value="" type="text">
								<span class="add-on">
									<i class="awe-calendar"></i>
								</span>
							</span>
							<label for="endTime" class="timepicker-label">at</label>
							<input name="endTime" class="timepicker input-small" value="" type="text">
		            ...
		            <div class="controls">
		                <textarea id="description" name="description" class="wysihtml5" placeholder="Event Details&hellip;" rows="8"><?php echo htmlentities($Event->description); ?></textarea>
		            </div>
		        </div>
